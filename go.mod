module github.com/meli-fresh-products-api-backend-go-t2
...
require (
	...
	github.com/melisource/fury_go-core v1.11.2 // indirect
	...
	github.com/testcontainers/testcontainers-go/modules/mysql v0.35.0 // indirect
