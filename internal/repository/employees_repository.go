...
func NewEmployeeRepository(db map[int]internal.Employee) *EmployeeRepository {
	// initialize a default database map if no `db` is provided
	defaultDb := make(map[int]internal.Employee)
	if db != nil {
		defaultDb = db
	}
...
func (r *EmployeeRepository) FindAll() (employees map[int]internal.Employee, err error) {
...
func (r *EmployeeRepository) FindById(id int) (employee internal.Employee, err error) {
...
func (r *EmployeeRepository) CreateEmployee(newEmployee internal.EmployeeAttributes) (employee internal.Employee, err error) {
...
func (r *EmployeeRepository) UpdateEmployee(inputEmployee internal.Employee) (employee internal.Employee, err error) {
