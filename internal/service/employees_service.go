...
func validateFields(newEmployee pkg.EmployeeAttributes) (err error) {
...
func validateDuplicates(employees map[int]pkg.Employee, newEmployee pkg.EmployeeAttributes) error {
